          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-gradient-to-r from-emerald-600 to-teal-500 rounded-xl flex items-center justify-center shadow-lg">
            ...
            {messages.map((message) => (
              ...
              >
                <Avatar className="w-10 h-10 shadow-md">
                  <AvatarFallback className={message.role === "user" ? "bg-emerald-100" : "bg-teal-100"}>
                    {message.role === "user" ? (
              ...
              <div className="flex items-end gap-3">
                <div className="flex-1">
                  <Input
                    ...
                    className="min-h-[56px] text-base border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 bg-white"
                    disabled={isLoading}
                  />
                </div>
                <Button
                  ...
                  className="h-14 w-14 p-0 bg-gradient-to-r from-emerald-600 to-teal-500 hover:from-emerald-700 hover:to-teal-600 shadow-lg hover:shadow-xl transition-all duration-200"
                >
                  {isLoading ? (
